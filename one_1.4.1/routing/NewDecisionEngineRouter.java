 ...
 */
public class NewDecisionEngineRouter extends ActiveRouter {
    ...
    public NewDecisionEngineRouter(Settings s) {
        super(s);
    ...
    public NewDecisionEngineRouter(DecisionEngineRouter r) {
        super(r);
        outgoingMessages = new LinkedList<Tuple<Message, Connection>>();
